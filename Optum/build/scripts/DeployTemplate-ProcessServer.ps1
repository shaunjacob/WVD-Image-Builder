# Path to template
$templateFilePath = Join-Path $PSScriptRoot ".." "templates" "ProcessServer.tpl.json"
...
$identityName = 'OSAIBIdentity'

# Image gallery name
$sigGalleryName = "OptumServeSIG"

#image definition 'name'
$destPublisher = 'OptumServe'
$destOffer = 'en-US'
...
. (Join-Path $PSScriptRoot "Get-AzureImageInfo-ProcessServer.ps1")
